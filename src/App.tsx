...
function ProtectedRoute({ 
  ...
  if (!skipFirstLoginCheck && user.role === 'employee' && !user.hasCompletedFirstLogin) {
  ...
  return (
    <Routes>
      ...
      <Route 
        path="/first-login" 
        element={
          <ProtectedRoute allowedRoles={['employee']} skipFirstLoginCheck={true}>
            <FirstLoginPage />
          </ProtectedRoute>
        } 
      />
