...
import type { SigningRequest } from './MockDataService';
...
export function RequestDetailPage() {
  ...
  const loadRequestDetail = async () => {
    ...
    try {
      setIsLoading(true);
      const requestData = await mockDataService.getSigningRequest(id);
  ...
  const handleSign = async () => {
    ...
    setIsSigning(true);
    try {
      // Mock signing - simulates eSign process
      const updatedRequest = await mockDataService.signDocument(request.id);
